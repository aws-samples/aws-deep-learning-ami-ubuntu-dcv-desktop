...
class CPTConfig:
    ...
    def from_dict(cls, config_dict: Dict) -> 'CPTConfig':
        """Reconstruct CPTConfig from dictionary."""
...
def train_func(config_dict: Dict):
    ...
    # Prepare datasets (rank 0 only, others poll for marker file)
...
def create_parser_from_dataclass(dataclass_type) -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Continual Pre-Training with Ray Train",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Example usage:
  python cpt_ray_train.py \\
    --hf_model_id Qwen/Qwen2.5-32B \\
    --hfdc_dataset_name wikimedia/wikipedia \\
    --hfdc_dataset_config 20231101.en \\
    --num_train_epochs 3 \\
