...
STACK_NAME="genai-${RANDOM}"
TEMPLATE_URL="https://raw.githubusercontent.com/aws-samples/aws-deep-learning-ami-ubuntu-dcv-desktop/main/deep-learning-ubuntu-desktop-basic.yaml"
TEMPLATE_FILE="/tmp/deep-learning-ubuntu-desktop-basic.yaml"
...
usage() {
  ...
  echo "Examples:"
  echo "  $0"
  echo "  $0 --instance-type p4d.24xlarge"
  echo "  $0 --instance-type g6.48xlarge --cidr 203.0.113.10/32"
  exit 1
}
...
aws cloudformation create-stack \
  ...
  --parameters \
    ...
    ParameterKey=DesktopInstanceType,ParameterValue="${INSTANCE_TYPE}" \
  --capabilities CAPABILITY_NAMED_IAM \
  --region "${REGION}" > /dev/null

echo "Stack creation initiated."
echo ""
echo "Waiting for stack to complete (this typically takes 30-60 minutes)..."
...
INSTANCE_ID=$(aws ec2 describe-instances \
  --filters "Name=tag:Name,Values=${STACK_NAME}-deep-learning-ubuntu-desktop" \
